...
const Home = () => {
  return (
    <LayoutDashboard>
      ...
      <section className="bg-gray-100 text-gray-800">
        <div className="container mx-auto flex flex-col items-center px-4 py-16 text-center md:py-32 md:px-10 lg:px-32 xl:max-w-3xl">
          ...
          <p className="px-8 mt-8 mb-12 text-lg">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem voluptatibus cumque doloremque incidunt vel dolores vero, eveniet autem, distinctio neque dignissimos repellat provident. Similique necessitatibus eos modi quia
            quos porro!
          </p>
      ...
      <section className="grid md:grid-cols-2 xl:grid-cols-4 mt-5 gap-6">
